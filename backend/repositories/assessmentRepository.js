 ...
 *
 * CODING:
 *   Initially receives 0 marks.
 *   Judge0 callback will grade it later.
 */
const submitAssessment = async (
    ...
    /*
     * Calculate MCQ answers.
     *
     * Coding answers remain at zero
     * until Judge0 grading completes.
     */
            ...
            (answer) => {
                ...
                if (
                    ...
                    if (
                        ...
                        throw new Error(
                            `Code is required for question ${question.id}`
                        );
                    }
     ...
     *
     * Coding questions will be updated
     * after Judge0 grading.
     */
 ...
 *
 * This is used when the student opens an assessment.
 * The frontend does not manually create a submission.
 */
...
const startAssessment = async (
    ...
    if (
        enrollmentRecord.batch?.course?.status !==
        "ACTIVE"
    ) {
    ...
    if (
        !assessment.module ||
        assessment.module.courseId !==
        enrollmentRecord.batch.courseId
    ) {
    ...
    const existingSubmission =
        await prisma.assessmentSubmission.findFirst({
...
const getAssessmentAnalytics = async (assessmentId) => {
    ...
    /*
     * ============================================================
     * GET ONLY COMPLETED / GRADED SUBMISSIONS
     *
     * IN_PROGRESS and SUBMITTED submissions are excluded
     * because their scores may not be final yet.
     * ============================================================
     */
 ...
 * ============================================================
 *
 * Called by Judge0 callback.
 *
 * IMPORTANT:
 * This function currently evaluates the Judge0 result
 * for the coding answer.
 *
 * The actual multi-test-case execution/grading will be
...
/*
 * Create one Judge0 execution record for one
 * coding test case.
 */
const createCodingTestCaseExecution = async ({
    ...
    const testCase =
        await prisma.codingTestCase.findUnique({
            where: {
    ...
    if (
        ...
        throw new Error(
            "Coding test case does not belong to the question"
        );
    }
...
/*
 * Find coding execution using Judge0 token.
 */
...
/*
 * Update one coding test-case execution
 * with Judge0 result.
 */
const updateCodingTestCaseExecution =
    async (
        ...
        if (!execution) {
            throw new Error(
                "Coding test case execution not found"
            );
        }


        const actualOutput =
            data.actualOutput !== undefined &&
        ...
        const expectedOutput =
            ...
            execution.expectedOutput !== null
                ...
                : String(
                    execution.testCase.expectedOutput
                );
...
const getCodingTestCasesByQuestion =
    ...
    /*
 * ============================================================
 * RECALCULATE CODING QUESTION SCORE
 * ============================================================
 */
    ...
    const score =
        answers.reduce(
            ...
            (total, answer) => {
                 ...
                 * IMPORTANT:
                 *
                 * Do NOT count the old coding
                 * question marks.
                 *
                 * Current coding marks are already
                 * calculated from latestExecutions.
                 */
 ...
 * ============================================================
 *
 * GFG-style coding submission result.
 */
...
const getAssessmentSubmissionResult =
    async (submissionId) => {
        ...
        /*
         * ========================================================
         * KEEP ONLY LATEST EXECUTION
         * FOR EACH QUESTION + TEST CASE
         * ========================================================
         */
        ...
        /*
         * ========================================================
         * DETERMINE CODING SUBMISSION
         * ========================================================
         */

        const hasCodingAnswer =
            ...
            executions.map(
                (
                    ...
                    return {
                        ...
                        /*
                         * Don't expose actual output
                         * of hidden test cases.
                         */
...
const createCodingQuestion = async (data) => {
    ...
    if (
        ...
        throw new Error(
            "At least one coding test case is required"
        );
    }
        ...
        data.testCases.map(
            (testCase, index) => {
                ...
                if (
                    ...
                    throw new Error(
                        `Invalid test case at position ${index + 1}`
                    );
                }
                ...
                if (
                    ...
                    throw new Error(
                        `Expected output is required for test case ${index + 1}`
                    );
                }

                const marks =
                    testCase.marks !== undefined
                        ? Number(testCase.marks)
                        : 1;
                ...
                if (
                    ...
                    throw new Error(
                        `Marks for test case ${index + 1} must be greater than 0`
                    );
                }
...
const createCodingTestCase = async (
    ...
    if (
        ...
        throw new Error(
            "Test case marks must be greater than 0"
        );
    }
